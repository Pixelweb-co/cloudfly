...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .exceptionHandling(exception -> exception.authenticationEntryPoint(customAuthenticationEntryPoint)) // Aquí
                                                                                                                    // se
                                                                                                                    // usa
                                                                                                                    // el
                                                                                                                    // EntryPoint
                ...
                .authorizeHttpRequests(http -> {
                    ...
                    // auth
                    http.requestMatchers(HttpMethod.GET, "/users/**").hasAnyRole("SUPERADMIN", "ADMIN", "BIOMEDICAL",
                            "USER");
                    ...
                    // products
                    http.requestMatchers(HttpMethod.GET, "/productos/**").hasAnyRole("SUPERADMIN", "ADMIN",
                            "BIOMEDICAL", "USER");
                    http.requestMatchers(HttpMethod.PUT, "/productos/**").hasAnyRole("SUPERADMIN", "ADMIN",
                            "BIOMEDICAL");
                    http.requestMatchers(HttpMethod.POST, "/productos/**").hasAnyRole("SUPERADMIN", "ADMIN",
                            "BIOMEDICAL");
                    http.requestMatchers(HttpMethod.DELETE, "/productos/**").hasAnyRole("SUPERADMIN", "ADMIN",
                            "BIOMEDICAL");
                    ...
                    http.requestMatchers(HttpMethod.GET, "/contacts/**").hasAnyRole("SUPERADMIN", "ADMIN", "BIOMEDICAL",
                            "USER");
                    http.requestMatchers(HttpMethod.PUT, "/contacts/**").hasAnyRole("SUPERADMIN", "ADMIN", "BIOMEDICAL",
                            "USER");
                    http.requestMatchers(HttpMethod.POST, "/contacts/**").hasAnyRole("SUPERADMIN", "ADMIN",
                            "BIOMEDICAL", "USER");
                    http.requestMatchers(HttpMethod.DELETE, "/contacts/**").hasAnyRole("SUPERADMIN", "ADMIN",
                            "BIOMEDICAL", "USER");

                    // quotes (cotizaciones)
                    http.requestMatchers(HttpMethod.GET, "/quotes/**").hasAnyRole("SUPERADMIN", "ADMIN", "BIOMEDICAL",
                            "USER");
                    http.requestMatchers(HttpMethod.POST, "/quotes/**").hasAnyRole("SUPERADMIN", "ADMIN", "BIOMEDICAL",
                            "USER");
                    http.requestMatchers(HttpMethod.PUT, "/quotes/**").hasAnyRole("SUPERADMIN", "ADMIN", "BIOMEDICAL",
                            "USER");
                    http.requestMatchers(HttpMethod.DELETE, "/quotes/**").hasAnyRole("SUPERADMIN", "ADMIN",
                            "BIOMEDICAL", "USER");

                    // invoices (facturas)
                    http.requestMatchers(HttpMethod.GET, "/invoices/**").hasAnyRole("SUPERADMIN", "ADMIN", "BIOMEDICAL",
                            "USER");
                    http.requestMatchers(HttpMethod.POST, "/invoices/**").hasAnyRole("SUPERADMIN", "ADMIN",
                            "BIOMEDICAL", "USER");
                    http.requestMatchers(HttpMethod.PUT, "/invoices/**").hasAnyRole("SUPERADMIN", "ADMIN", "BIOMEDICAL",
                            "USER");
                    http.requestMatchers(HttpMethod.DELETE, "/invoices/**").hasAnyRole("SUPERADMIN", "ADMIN",
                            "BIOMEDICAL", "USER");

                    // orders (ventas POS)
                    http.requestMatchers(HttpMethod.GET, "/orders/**").hasAnyRole("SUPERADMIN", "ADMIN", "BIOMEDICAL",
                            "USER");
                    http.requestMatchers(HttpMethod.POST, "/orders/**").hasAnyRole("SUPERADMIN", "ADMIN", "BIOMEDICAL",
                            "USER");
                    http.requestMatchers(HttpMethod.PATCH, "/orders/**").hasAnyRole("SUPERADMIN", "ADMIN", "BIOMEDICAL",
                            "USER");
                    http.requestMatchers(HttpMethod.DELETE, "/orders/**").hasAnyRole("SUPERADMIN", "ADMIN",
                            "BIOMEDICAL", "USER");
                    ...
                    // categorias
                    http.requestMatchers(HttpMethod.GET, "/categorias/**").hasAnyRole("SUPERADMIN", "ADMIN",
                            "BIOMEDICAL", "USER");
                    http.requestMatchers(HttpMethod.PUT, "/categorias/**").hasAnyRole("SUPERADMIN", "BIOMEDICAL",
                            "ADMIN");
                    http.requestMatchers(HttpMethod.POST, "/categorias/**").hasAnyRole("SUPERADMIN", "BIOMEDICAL",
                            "ADMIN");
                    http.requestMatchers(HttpMethod.DELETE, "/categorias/**").hasAnyRole("SUPERADMIN", "BIOMEDICAL",
                            "ADMIN");

                    // plantilla verficacion

                    http.requestMatchers(HttpMethod.GET, "/plantillas-verificacion/**").hasAnyRole("SUPERADMIN",
                            "ADMIN", "BIOMEDICAL", "USER");
                    http.requestMatchers(HttpMethod.PUT, "/plantillas-verificacion/**").hasAnyRole("SUPERADMIN",
                            "BIOMEDICAL");
                    http.requestMatchers(HttpMethod.POST, "/plantillas-verificacion/**").hasAnyRole("SUPERADMIN",
                            "BIOMEDICAL");
                    http.requestMatchers(HttpMethod.DELETE, "/plantillas-verificacion/**").hasAnyRole("SUPERADMIN",
                            "BIOMEDICAL");

                    // dashboard overview (lectura)
                    http.requestMatchers(HttpMethod.GET, "/dashboard/**").hasAnyRole("SUPERADMIN", "ADMIN",
                            "BIOMEDICAL", "USER");
